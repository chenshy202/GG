# =============================================================================
# Implementation of the supervised Graph Encoder Embedding (GEE) algorithm for
...
#
# This file contains:
#   GEE: This is the supervised GEE algorithm.
# =============================================================================
import numpy as np
...
def GEE(n, E, Y):
  """
  Computes node embeddings based on semi-supervised label information.

  Args:
      n (int): The total number of nodes in the graph.
      E (list): The graph edge list, with each element as a list or tuple
                in the format `[node_i, node_j, weight]`.
      Y (np.ndarray): A matrix of node labels. The shape is (n, 1), and 
                      test nodes can be masked (e.g., with -1).

  Returns:
      torch.Tensor: The L2-normalized node embeddings, returned as a
                    PyTorch tensor of shape (n, k).
  """
